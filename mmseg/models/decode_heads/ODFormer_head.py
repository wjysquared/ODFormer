...
class LBFRBlock(nn.Module):
    def __init__(self,
        ...
        self.conv_hori1 = nn.Conv1d(in_channels, out_channels, kernel_size=7, stride=1, padding=3)
        self.conv_verti1 = nn.Conv1d(in_channels, out_channels, kernel_size=7, stride=1, padding=3)
...
class ODFormerHead(BaseDecodeHead):
    ...
    def __init__(self, pool_scales=(1, 2, 3, 6), **kwargs):
        super(ODFormerHead, self).__init__(
